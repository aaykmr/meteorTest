...
export const Signup = () => {
  ...
  const submit = (e) => {
    ...
    if (username === "") {
      flag = 0;
      document.getElementsByClassName("newuser")[0].style.backgroundColor =
        "#4a1f1f";
    } else {
      document.getElementsByClassName("newuser")[0].style.backgroundColor =
        "black";
    ...
    if (password === "") {
      flag = 0;
      document.getElementsByClassName("newpass")[0].style.backgroundColor =
        "#4a1f1f";
    } else {
      document.getElementsByClassName("newpass")[0].style.backgroundColor =
        "black";
    ...
    if (conPassword === "") {
      flag = 0;
      document.getElementsByClassName("conpass")[0].style.backgroundColor =
        "#4a1f1f";
    } else {
      document.getElementsByClassName("conpass")[0].style.backgroundColor =
        "black";
    ...
    if (password === conPassword) {
      if (flag === 1) {
        var result = Object.keys(
          Cred.find("collection").collection._docs._map
        ).map((key) => [
          Number(key),
          Cred.find("collection").collection._docs._map[key],
        ]);
        var f = 1;
        result.forEach((element) => {
          if (element[1].username === username) {
            ...
            document.getElementsByClassName(
              "newuser"
            )[0].style.backgroundColor = "#4a1f1f";
